...
void MNCS::GetNameplateInfo(CanvasWrapper canvas)
{
...
void MNCS::GetIndividualNameplate(CanvasWrapper canvas, RT::Frustum &frustum, json::JSON& nameplatesState, CarWrapper car)
{
    CameraWrapper camera = gameWrapper->GetCamera();
...
float MNCS::GetBallVerticalRadius(CanvasWrapper canvas, BallWrapper ball, CameraWrapper camera, RT::Frustum &frustum)
{
